...
> Generated: 2026-09-07 12:13 UTC by `scripts/reflect.py`
...
**[GIT / velocity]** 10 commits in the last 30 days (0.33/day).
> 💡 Aim for at least 1 commit per active development day.

**[GIT / quality]** 8/10 commits (80%) follow Conventional Commits format.

**[GIT / churn]** Top churn files: .github/rules/registry.json, .github/skills/registry.json, docs/adr/ADR-009-outward-and-forward-loops.md.
